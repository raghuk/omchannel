    ...
    render() {
        return (
            <ScrollView style={styles.content}>
                ...
                <Text style={styles.info}>Thank you for using the app. We request you to leave us your feedback at info@godlywoodstudio.org to help us to improve the app with addtinal features.</Text>
                ...
                <Text style={styles.info}>{`Contact No: 02974229988\n\n`}</Text>
            </ScrollView>
        );
    }
}
